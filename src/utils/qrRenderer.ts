 ...
 * @param config The QR configuration object.
 * @param size The size of the canvas (display size).
 * @param qrData The generated QR code data (modules).
 * @param logoImg The loaded logo image element, or null.
 * @param borderLogoImg The loaded border logo image element, or null.
 */
export const drawQR = (
  ...
  ctx.canvas.width = rawSize;
  ctx.canvas.height = rawSize;
