...
describe("Performance Benchmark: renderModules", () => {
  ...
  test(
    "Benchmark HIVE execution time",
    () => runBenchmark(QRStyle.HIVE, "HIVE"),
    10000,
  );
  test(
  ...
  test(
    "Benchmark MODERN execution time",
    () => runBenchmark(QRStyle.MODERN, "MODERN"),
    10000,
  );
  test(
    "Benchmark CIRCUIT execution time",
    () => runBenchmark(QRStyle.CIRCUIT, "CIRCUIT"),
    10000,
  );
  test(
    "Benchmark SWISS execution time",
    () => runBenchmark(QRStyle.SWISS, "SWISS"),
    10000,
  );
  test(
