      ...
      <ul className="grid grid-cols-4 gap-2 p-2 bg-slate-100 dark:bg-slate-800 rounded-xl transition-colors duration-300">
        ...
        { type: QRType.MEETING, icon: Video, label: "Meeting" },
          ...
          isActive
            ...
            : "text-slate-600 dark:text-slate-400 hover:text-slate-700 dark:hover:text-slate-200 hover:bg-slate-100 dark:hover:bg-slate-800 bg-transparent border border-transparent"
        }`;
            ...
            return (
              <li key={item.type}>
                ...
                >
                  ...
                  <span className="whitespace-normal break-words w-full text-center">
                    {item.label}
                  </span>
                </a>
              </li>
            ...
            <li key={item.type}>
              <Button
                ...
                className={`flex-col w-full h-auto items-center justify-center gap-1 px-2 py-2 rounded-lg text-xs font-medium ${
                  isActive ? "" : "border border-transparent hover:text-slate-700 dark:hover:text-slate-200"
                }`}
              >
                <item.icon className="w-4 h-4" />
                <span className="whitespace-normal break-words w-full text-center">
