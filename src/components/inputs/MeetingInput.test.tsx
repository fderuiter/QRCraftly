...
describe("MeetingInput", () => {
  ...
  it("displays Zoom meeting details correctly", () => {
    const data: MeetingData = {
      url: "https://zoom.us/j/987654321?pwd=MyPasscode",
    };
  ...
  it("displays Teams meeting details correctly", () => {
    ...
    expect(
      screen.getByText("Microsoft Teams link detected"),
    ).toBeInTheDocument();
    expect(
      screen.getByText("19:meeting_MDIxYm...@thread.v2"),
    ).toBeInTheDocument(); // Meeting ID (from thread)
  });
