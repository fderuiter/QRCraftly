        ...
        <div className="mt-4 space-y-4" id="advanced-settings-panel">
          <div>
            ...
            >
              {[
                {
                  id: QRErrorCorrectionLevel.L,
                  label: "Low (~7%)",
                  desc: "Best for screens",
                },
                {
                  id: QRErrorCorrectionLevel.M,
                  label: "Medium (~15%)",
                  desc: "Standard",
                },
                {
                  id: QRErrorCorrectionLevel.Q,
                  label: "Quartile (~25%)",
                  desc: "Good for print",
                },
                {
                  id: QRErrorCorrectionLevel.H,
                  label: "High (~30%)",
                  desc: "Best for logos",
                },
              ].map((level) => (
            ...
            <p className="text-[10px] text-slate-500 dark:text-slate-400 mt-2">
              Higher levels allow the QR code to be scanned even if damaged or
              covered (e.g., by a logo), but result in a denser code.
            </p>
          </div>
        </div>
      )}
