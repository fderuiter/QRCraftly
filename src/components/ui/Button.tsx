...
export const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className = '', variant = 'secondary', size = 'md', fullWidth = false, ...props }, ref) => {
    ...
    let baseStyles = 'inline-flex items-center justify-center font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed';
    ...
    switch (variant) {
      ...
      case 'secondary':
        ...
        break;
      case 'error':
        variantStyles = 'bg-rose-50 dark:bg-rose-900/20 border border-rose-200 dark:border-rose-800 text-rose-700 dark:text-rose-400 hover:bg-rose-100 dark:hover:bg-rose-900/40';
        break;
      case 'outline':
    ...
    if (variant === 'menuitem') {
      sizeStyles = 'w-full text-left px-4 py-2.5 text-sm flex items-center gap-2 rounded-none';
    }
