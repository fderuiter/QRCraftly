                    ...
                    {showDownloadMenu && (
                      ...
                      >
                        <Button
                          ...
                          variant="menuitem"
                        >
                          <div className="w-1.5 h-1.5 rounded-full bg-teal-500"></div> PNG (High
                          Quality)
                        </Button>
                        <Button
                          ...
                          variant="menuitem"
                        >
                          <div className="w-1.5 h-1.5 rounded-full bg-blue-500"></div> JPEG
                          (Compact)
                        </Button>
                        <Button
                          ...
                          variant="menuitem"
                        >
                          <div className="w-1.5 h-1.5 rounded-full bg-purple-500"></div> WebP
                          (Modern)
                        </Button>
                        <div
                        ...
                        <Button onClick={handleSaveSvg} role="menuitem" variant="menuitem">
                          <div className="w-1.5 h-1.5 rounded-full bg-orange-500"></div> SVG
                          (Vector)
                        </Button>
                      </div>
                    )}
                ...
                {showTelemetryPrompt && (
                  <div className="mt-4 p-4 bg-slate-50 dark:bg-slate-800 rounded-lg border border-slate-200 dark:border-slate-700 text-sm">
                    ...
                    <p className="text-slate-600 dark:text-slate-400 mb-3 text-xs leading-relaxed">
                      We noticed your QR code might be hard to scan. Would you like to send an
                      anonymous telemetry ping to help us fix bugs?
                      <br />
                      <br />
                      <strong>Privacy Guarantee:</strong> We only send your device engine and style
                      settings. We <strong>never</strong> send the QR content or image.
                    </p>
                    <div className="flex gap-2">
                      <Button
                        variant="primary"
