...
export const contentRegistry: Record<string, ToolContent> = {
  ...
  'email-qr-code': {
    ...
    description: '',
    features: ['Generate Pre-filled Emails', 'Secure Client-Side', 'Custom Design'],
    howTo: {
  ...
  'payment-qr-code': {
    ...
    description: '',
    features: ['Generate Crypto Payment QR', 'Bitcoin/Ethereum Support', 'Secure Client-Side'],
    howTo: {
  ...
  'phone-qr-code': {
    ...
    description: '',
    features: ['Generate Click-to-Call QR', 'Secure Client-Side', 'Custom Design'],
    howTo: {
  ...
  'sms-qr-code': {
    ...
    description: '',
    features: ['Generate Pre-filled SMS', 'Secure Client-Side', 'Custom Design'],
    howTo: {
  ...
  'vcard-qr-code': {
    ...
    description: '',
    features: ['Generate VCard Contact QR', 'Secure Client-Side', 'Custom Design'],
    howTo: {
  ...
  'wifi-qr-code': {
    ...
    description: '',
    features: ['Generate WiFi Access QR Codes', 'WPA/WPA2 Support', 'Hidden SSID Support'],
    howTo: {
