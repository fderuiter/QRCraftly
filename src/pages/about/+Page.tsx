    ...
    <div className="max-w-5xl mx-auto px-4 py-12">
      ...
      <div className="text-center mb-16">
        ...
        <p className="text-lg text-slate-600 dark:text-slate-300 max-w-2xl mx-auto">
          A privacy-focused QR code generator built with modern web technologies. Entirely free with
          no login required.
        </p>
      </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-700 text-center">
            ...
            <p className="text-slate-600 dark:text-slate-400">
              QRCraftly is completely free to use. No sign-up, no login, and no hidden fees. Just
          ...
          <div className="bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-700 text-center">
            ...
            <p className="text-slate-600 dark:text-slate-400">
              We do not use tracking pixels, cookies, or third-party analytics. We only collect
              basic server logs for performance and reliability.
            </p>
          </div>
          ...
          <div className="bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-700 text-center">
            ...
            <p className="text-slate-600 dark:text-slate-400">
              We utilize a Zero Knowledge architecture. Your content is processed entirely in your
              browser and never transmitted to our servers.
            </p>
          </div>
      ...
      <section className="mb-16 bg-gradient-to-br from-rose-50 to-orange-50 dark:from-rose-900/20 dark:to-orange-900/20 rounded-2xl p-8 md:p-12 border border-rose-100 dark:border-rose-800/30 text-center relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <p className="text-lg text-slate-600 dark:text-slate-300 max-w-2xl mx-auto mb-8 leading-relaxed">
            QRCraftly is 100% free, open-source, and privacy-respecting. If you find this tool
            helpful, consider buying me a coffee! Your support helps cover hosting costs and fuels
            future development.
          </p>
          <a
      ...
      <section className="bg-slate-50 dark:bg-slate-800/50 rounded-2xl p-8 border border-slate-200 dark:border-slate-700 text-center mb-12">
        ...
        <p className="text-slate-600 dark:text-slate-300 mb-8 max-w-2xl mx-auto">
          ...
          <strong>GNU Affero General Public License v3.0 (AGPL-3.0)</strong>. This ensures that the
          software remains free and open source for everyone.
        </p>
        <a
