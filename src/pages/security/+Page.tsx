    ...
    <div className="max-w-5xl mx-auto px-4 py-12">
      ...
      <div className="text-center mb-16">
        ...
        <p className="text-lg text-slate-600 dark:text-slate-300 max-w-2xl mx-auto">
          We believe in complete transparency. Our architecture ensures your
          data remains yours, with privacy-first processing.
        </p>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-12 mb-16">
        <section
          ...
          className="bg-white dark:bg-slate-800 p-8 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-700 prose dark:prose-invert prose-slate max-w-none"
        >
      ...
      <section className="bg-gradient-to-br from-indigo-50 to-teal-50 dark:from-indigo-900/20 dark:to-teal-900/20 rounded-2xl p-8 md:p-12 border border-indigo-100 dark:border-indigo-800/30 text-center relative overflow-hidden">
        <div className="relative z-10">
          ...
          <p className="text-lg text-slate-600 dark:text-slate-300 max-w-2xl mx-auto mb-8 leading-relaxed">
            Security is our top priority. If you have discovered a security
            vulnerability, we want to hear from you immediately through our
            secure channel.
          </p>
          <a
