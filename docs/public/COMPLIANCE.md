...
- **Animation Loop Frames & Visual States:** Any cached frames, style parameters, or matrices generated for animation loops and adaptive geometric compensation states (like `isCompensationEnabled`) are also kept solely in volatile client-side memory.
