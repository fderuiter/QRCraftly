...
- **Alert** (`Alert.tsx` / `Alert.test.tsx`): Displays warning, error, or informational status banners with accessible dismiss action and full WCAG contrast compliance.
